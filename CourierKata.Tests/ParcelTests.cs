...
namespace CourierKata.Tests
{
    public class ParcelTests
    {
        ...
        {
            var parcel = new Parcel(49, 49, 49);
            Assert.Equal(ParcelSize.Medium, parcel.Size);
        }
        ...
        {
            var parcel = new Parcel(99, 99, 99);
            Assert.Equal(ParcelSize.Large, parcel.Size);
        }
        ...
        {
            var smallParcel = new Parcel(3, 4, 5);
            var mediumParcel = new Parcel(3, 4, 11);
            var largeParcel = new Parcel(3, 75, 5);
            var extraLargeParcel = new Parcel(120, 4, 5);
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => new Parcel(1, 2, 0));
            Assert.Throws<ArgumentOutOfRangeException>(() => new Parcel(1, -2, 3));
        }
    }
}